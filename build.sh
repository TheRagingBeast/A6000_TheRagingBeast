...
export CROSS_COMPILE=/home/younilban/kernel/a6000/gcc4.8/bin/arm-eabi-

#tc>arm-linaro-7.x
#git clone --recursive https://github.com/nathanchance/gcc-prebuilts -b arm-linaro-7.x arm-linaro-7.x
#export CROSS_COMPILE=/home/younilban/kernel/a6000/arm-linaro-7.x/bin/arm-linaro-linux-androideabi-
...
make -C $PWD O=$PWD/out ARCH=arm lineageos_a6000_defconfig
